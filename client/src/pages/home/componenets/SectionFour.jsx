  ...
  return (
    ...
    <div className="flex flex-col md:flex-row max-w-6xl w-full px-6 py-12 space-y-8 md:space-y-0 md:space-x-12">
      ...
      <div className="md:w-1/2">
        <h3 className="text-gray-500 text-sm font-semibold mb-2">Why Halodek?</h3>
        <h1 className="text-4xl font-bold text-gray-800 mb-4">
          Our mission is user convenience
        </h1>
        <p className="text-gray-600">
          Halodek makes your communication with relatives, work friends, and family more fun. Stay connected with them with plentiful features.
        </p>
      </div>
      ...
      <div className="md:w-1/2 grid grid-cols-2 gap-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-3xl font-bold">2B+</h2>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-3xl font-bold">500M</h2>
